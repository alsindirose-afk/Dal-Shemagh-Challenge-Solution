...
J_{\text{cons}} =
\frac{1}{2}
\left(1 - \sum_{i=1}^{N} \theta_i \right)^2
\]
...
y \log(\theta_i p_i)
+
(1 - y)\log(1 - \theta_i p_i)
\right]
\]

where:
- \( p_i \) denotes the class probability predicted by the \( i \)-th model
...
\begin{bmatrix}
\dfrac{p_1 \theta_1 - y}{\theta_1 (1 - \theta_1 p_1)} \\
\vdots
\end{bmatrix}
\]
